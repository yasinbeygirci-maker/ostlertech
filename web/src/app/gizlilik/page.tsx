...
export const metadata: Metadata = {
  title: "Gizlilik Politikası / Privacy Policy | OstlerTech",
  description:
    "SyncPass, DiaSync ve diğer OstlerTech uygulamalarının gizlilik politikası: veri güvenliği, sıfır bilgi şifreleme ve sağlık verisi koruması.",
};
