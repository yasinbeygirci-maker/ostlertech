...
export const metadata: Metadata = {
  title: "Privacy Policy / Gizlilik Politikası | OstlerTech",
  description:
    "OstlerTech uygulamaları (SyncPass, DiaSync) gizlilik politikası: veri toplama, işleme ve üçüncü taraf paylaşım politikaları.",
};
